...
def add_task(tasks_list: dict):
    ...
    priority = check_input("Please enter the priority (1 - LOW, 2 - MEDIUM or 3 - HIGH): ", LEVELS)
    status = check_input("Please enter the status (1 - New, 2 - In process or 3 - Done): ", LEVELS)
    tasks_list[id] = {
        "name": name,
